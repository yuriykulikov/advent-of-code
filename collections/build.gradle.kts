...
rootProject.group = "extensions.kotlin"
...
bintray {
    user = rootProject.properties.getOrDefault("bintrayUser", System.getenv("BINTRAY_USER") ?: "") as String
    key = rootProject.properties.getOrDefault("bintrayApiKey", System.getenv("BINTRAY_API_KEY") ?: "") as String
